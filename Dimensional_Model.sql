...
CREATE OR REPLACE TABLE dim_route (
    route_key INT AUTOINCREMENT START 1 INCREMENT 1 PRIMARY KEY,
...
-- Habilitar Time Travel (20 días)
ALTER TABLE fact_deliveries SET DATA_RETENTION_TIME_IN_DAYS = 20;
ALTER TABLE dim_date SET DATA_RETENTION_TIME_IN_DAYS = 20;
ALTER TABLE dim_vehicle SET DATA_RETENTION_TIME_IN_DAYS = 20;
ALTER TABLE dim_driver SET DATA_RETENTION_TIME_IN_DAYS = 20;
ALTER TABLE dim_route SET DATA_RETENTION_TIME_IN_DAYS = 20;
ALTER TABLE dim_customer SET DATA_RETENTION_TIME_IN_DAYS = 20;
ALTER TABLE dim_time SET DATA_RETENTION_TIME_IN_DAYS = 20;
