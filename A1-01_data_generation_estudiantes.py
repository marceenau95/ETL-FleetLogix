...
class DataGenerator:
    ...
    def generate_trips(self, count=100000):
        ...
        self.cursor.execute("SELECT route_id, distance_km as distance, estimated_duration_hours as est_duration FROM routes")
    ...
    def generate_deliveries(self, count=400000):
        ...
        self.cursor.execute("SELECT t.trip_id, t.departure_datetime as departure, t.arrival_datetime as arrival ,t.total_weight_kg as total_weight, r.destination_city as city FROM trips as t JOIN routes as r on r.route_id = t.route_id ")
    ...
    def generate_maintenance(self, count=5000):
        ...
        self.cursor.execute("SELECT t.vehicle_id, v.vehicle_type, COUNT(t.trip_id) as trip_count, MAX(t.departure_datetime) as last_trip, MIN(t.departure_datetime) as first_trip FROM trips as t JOIN vehicles as v on t.vehicle_id=v.vehicle_id GROUP BY t.vehicle_id, v.vehicle_type ")
